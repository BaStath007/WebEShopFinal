...
namespace WebEShopFinal.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Price,Category")] Product product)
        {
            if (ModelState.IsValid)
            {
                //var catId = _context.Categories.Single(c => c.Title == "NO NAME").Id;
                var myCat = _context.Categories.Single(c => c.Title == "NO NAME");
